    ...
    <div class="row">
        <form id="from_socketInfo" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <select id="socketInfo_type" name="socketInfo_type"
                        ...
                        <option selected="selected" value="0">客户端</option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <button type="button" class="btn btn-primary" id="btnCreateClient"
                            data-loading-text="Loading..." data-complete-text="Loading finished"
                            onclick="submitForm('btnCreateClient')">创建Client
                    </button>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-1"></div>
                <div class="col-sm-2">
                    <button type="button" class="btn btn-primary" id="btnCreateClientFast"
                            data-loading-text="Loading..." data-complete-text="Loading finished"
                            onclick="createClientFast('btnCreateClientFast')">一键创建Client
                    </button>
                </div>
            </div>
        </form>
